    ...
    return (
      <main className="h-[calc(100vh-56px)] overflow-auto px-4 py-8 sm:px-6 sm:py-10">
        <div className="mx-auto max-w-6xl space-y-4">
          ...
          <div className="h-24 animate-pulse rounded-xl bg-app-surface shadow-sm" />
  ...
  return (
    <main className="h-[calc(100vh-56px)] overflow-auto px-4 py-8 sm:px-6 sm:py-10">
      <div className="mx-auto max-w-6xl space-y-6">
        ...
        <section className="rounded-xl bg-app-surface p-5 shadow-sm">
          <div className="flex flex-wrap items-center justify-between gap-3">
            <div className="flex items-center gap-2">
              ...
              <select
                id="state-filter"
                className="rounded-md border border-app-border bg-white px-3 py-2 text-sm"
                value={selectedState}
        ...
        <section className="rounded-xl bg-app-surface p-5 shadow-sm">
          <details>
            <summary className="cursor-pointer text-base font-semibold text-app-text">
